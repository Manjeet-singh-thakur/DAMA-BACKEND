...
authObj.login = async function (req, res) {
  ...
  if (req && req.body && req.body.email && req.body.password) {
    // console.log(req.body.email,"Entered mail++++++++++++++++++++++++++");
    // console.log("12345678","Entered Password++++++++++++++++++++++++++++");
    let checkEmailObj = {
    ...
    // console.log(checkEmailDetail[0].au_password,"savedPass+++++++++++++++++++++++");
    // console.log(passwordHash.verify(req.body.password,checkEmailDetail[0].au_password),"check Matched Password+++++++++++++++++++++++");
    // console.log("checkEmailDetail", checkEmailDetail);
    // console.log(await verifyPassword.compare(req.body.password,checkEmailDetail[0].au_password),"_________________ppppppppppppppppp")
    if (checkEmailDetail && checkEmailDetail.length > 0) {
      ...
      if (
        ...
        console.log("00000000000000000000000000000000000000000",passwordHash.isHashed(req.body.password)) // false
        console.log("000000000000000000000000000000000000000001111111111111111111111111111111111111111111111",passwordHash.isHashed(userData.au_password)) // true
