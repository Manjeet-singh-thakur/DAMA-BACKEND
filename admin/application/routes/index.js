...
module.exports = function () {
  ...
  app.get("/admin/get-user-by-id/:id", userObj.getuserById);
  ...
  app.post("/admin/create-member-upload", memberObj.uploadProfileImage);
  ...
  app.post('/admin/insert-user-payment', userObj.insertPayment);

  // endpoint for handle response of safaricom business pay bills api
  app.post('/admin/b2b/result/',userObj.paymentResult)

  // Queue timeout endpoint
  app.post('/admin/b2b/queue/', userObj.paymentQueueTimeout);
